...
INSERT INTO app_user (id, first_name, last_name, password, username,tenant_id) VALUES (1, 'John', 'Doe', '$2a$10$qtH0F1m488673KwgAfFXEOWxsoZSeHqqlB/8BTt3a6gsI5c2mdlfe', 'john.doe',1);
INSERT INTO app_user (id, first_name, last_name, password, username,tenant_id) VALUES (2, 'Admin', 'Admin', '$2a$10$qtH0F1m488673KwgAfFXEOWxsoZSeHqqlB/8BTt3a6gsI5c2mdlfe', 'admin.admin',2);
